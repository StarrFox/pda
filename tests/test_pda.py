# TODO: update tests file i.e utils.data_dir
import requests
import os
import io
import unittest
...
from pda.listdb.github_issues import GithubIssues
...
"""
    ...
    cfg = PdaConfig(io.StringIO(localmode_test_config))
    ...
    def testRemoteMode(self):
        self.assertTrue(ConfigLocalModeTests.cfg.remote_mode is False)
...
"""
    ...
    cfg = PdaConfig(io.StringIO(remotemode_test_config))
    ...
    def testRemoteMode(self):
        self.assertTrue(ConfigRemoteModeTests.cfg.remote_mode is True)
...
"""
        ...
        self.tl = [
            str(self.db.add_task("test summary 1", "todo", "week", "must")),
    ...
    def testRemoveTask(self):
        ...
        with patch("sys.stdout", new=MockDevice()):
    ...
    def testEditTask(self):
        ...
        self.db.edit_task(self.tl[2], new_priority="low")
...
class ListDBSyncingTests(unittest.TestCase):
    ...
    def testSyncLocalDBStore(self):
        ...
        r = requests.get(
            self.db.url_issues, params={"state": "open"}, auth=self.db.auth
        )
    ...
    def testSyncRemoteDBStore(self):
        ...
        if self.db.shelf:
            ...
            task_numbers = [
                number
                for number in list(self.db.shelf.keys())
            ...
            self.db.edit_task(
                int(added_2nd), new_milestone="season", new_tasktype="toread"
            )
